...
<head>
    ...
    <title>Patient Educational</title>
        ...
        <div class="section-heading">
            <div class="section">
                <div class="span-title">
                    <h1>Patient Educational</h1>
                    <div class="page-map"><p>Category &nbsp;/&nbsp;Patient Education</p></div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <?php foreach($rows as $row) { ?>
                        ...
                        <div class="post-preview">
                            ...
                            <div class="post-details">
                                ...
                                <p class="author"><i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp; <?php echo $row['post_created_at']; ?></p>
                                <p><a href="detail-patient.php?id=<?php echo $row['post_id']; ?>" ><button type="button" class="btn btn-primary">Read More</button></a></p>
                            </div>
                        </div>
                    <?php } ?>
                </div>
