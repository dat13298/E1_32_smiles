...
<div class="container-xl">
    <div class="table-responsive">
        ...
        <div class="table-wrapper">
            <div class="table-title-patient">
                <div class="row">
                    <div class="col-sm-6">
                        <h2><b>Patient Education Posts List</b></h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="add-patient.php" class="btn btn-success" data-toggle="modal"><i class="fa-solid fa-plus"></i> <span>Add Post</span></a>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit-patient.php?post_id=<?php echo $row['post_id'] ?>" class="edit"><i
                                    class="fa-regular fa-pen-to-square"></i></a>
                        <?php if ($row['post_is_deleted'] == 1): ?>
                            <a href="restore-patient.php?post_id=<?php echo $row['post_id'] ?>" class="restore"><i class="fa-solid fa-rotate-left"></i></a>
                        <?php else: ?>
                            <a href="delete-patient.php?post_id=<?php echo $row['post_id'] ?>" class="delete"><i class="fa-solid fa-trash"></i></a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php } ?>
