...
if (isset($_POST['confirm'])) {
    ...
    if (empty($errorMessages)) {
        ...
        $uploadedFile = $file ? $file['tmp_name'] : null;
        $uploadedFileName = $file ? $file['name'] : null;

   
        $editSuccess = editPatientPosts($PostId, $title, $content, $uploadedFile, $uploadedFileName, $mediaTitle, $folderName);
        if (!$editSuccess) {
...
<div class="container">
    <div class="form-container bg-light border rounded p-4 shadow">
        ...
        <form action="edit-patient.php?post_id=<?php echo $PostId ?>" method="post" enctype="multipart/form-data" onsubmit="return validateUpdateForm()">
